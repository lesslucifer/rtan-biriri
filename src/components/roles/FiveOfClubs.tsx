...
export default function FiveOfClubs() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-lg px-6 py-8 border-2 border-green-100">
        <div className="text-center mb-4">
          <div className="flex justify-center mb-4">
            <Card card={card} scale={0.8} />
          </div>
          <h2 className="text-3xl font-bold text-green-600 mb-2">5 of Clubs ♣</h2>
          <p className="text-lg font-semibold text-gray-700">The Guardian</p>
        </div>
